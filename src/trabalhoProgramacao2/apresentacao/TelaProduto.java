...
import trabalhoProgramacao2.modelo.controllerProduto;
import trabalhoProgramacao2.modelo.ApenasNumero;
...
public class TelaProduto extends javax.swing.JDialog {
    ...
    public TelaProduto(java.awt.Frame parent, boolean modal) {
        ...
        this.txtValor.setDocument(new ApenasNumero());
        this.txtCodigo.setDocument(new ApenasNumero());
    }
